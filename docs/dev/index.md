...
| 项目 | 说明 |
|------|------|
| [desktop](./desktop/) | Electron 客户端，课表展示与插件系统 |
| [usr-backend](./usr-backend/) | Go 后端 API，课表数据与规则引擎 |
| [usr-dashboard](./usr-dashboard) | Vue3 用户管理后台 |
| [sys-backend](./sys-backend) | Go 系统后端，SaaS 租户管理 |
| [sys-dashboard](./sys-dashboard) | Vue3 系统管理面板 |
| [go-valence-cal](./go-valence-cal) | 调休计算库 |
| [文档贡献](./docs-contrib) | Rspress 文档站（docs-site）开发与编写规范 |
